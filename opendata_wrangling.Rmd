...
ggplot() +
  ...
  scale_colour_manual(values = palette5,
                   ...
                   name="Quintile\nBreaks") +
  labs(title="Price Per Square Foot, Mecklenberg") +
  mapTheme()
```
...
st_drop_geometry(salegroup) %>% 
  ...
  dplyr::select(price, age, heatedarea, bedrooms,homelessshelter_nn1,park_nn1,park_nn3,landfill,flood100y,school_nn1,school_nn2,school_nn3,bus_nn1,station_nn1) %>%
