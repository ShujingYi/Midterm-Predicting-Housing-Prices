...
bothRegressions <- 
  rbind(
    dplyr::select(Mecklenberg.test, starts_with("price"), Regression, npa, SalePrice.Predict,SalePrice.Error,SalePrice.AbsError,SalePrice.APE) ,
    dplyr::select(Mecklenberg.test.nhood, starts_with("price"), Regression, npa, SalePrice.Predict, SalePrice.Error,SalePrice.AbsError,SalePrice.APE))   
```
