...
The first part of variables our model is using is the external
...
```{r}
stargazer(as.data.frame(salegroup[c("price","heatedarea","bedrooms","fullbaths","halfbaths","numfirepla","foundation","heatedfuel","actype","units","accounttyp")]), type="text", 
...
inTrain <- createDataPartition(
              y = paste(salegroup$story.cat,salegroup$age.cat,salegroup$heatedfuel, salegroup$actype), 
              p = .60, list = FALSE)
